...
import { getUserLectures, askQuestion, getLectureQuestion, getAudioUrl } from '../services/api'
            ...
            <div className="max-w-5xl mx-auto py-8 px-4">
                ...
                <div className="flex gap-4 mb-4">
                    ...
                    <div className={`bg-white rounded-2xl border border-gray-200 p-8 ${lecture.visual_url ? 'w-2/3' : 'w-full'}`}>
                        ...
                        <div className="min-h-[200px] text-lg leading-relaxed" ref={textContainerRef}>
                ...
                <div className="bg-white rounded-2xl border border-gray-200 p-6">
                    ...
                    <div className="flex gap-2 mb-6">
                        <input
                            ...
                            placeholder={`Ask ${lecturer.name} a question...`}
                        />
